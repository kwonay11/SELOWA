<template>
  <Slide id="page-wrap">
    <span v-if="login"><router-link :to="{ name: 'Movie' }" class="fas fa-church font-weight-bolder " style="color:#e0435e;text-decoration:none"> Movie</router-link></span>
    <span v-if="login"><router-link :to="{ name: 'Community' }" class="fas fa-church font-weight-bolder " style="color:#e0435e;text-decoration:none"> Community</router-link></span>
